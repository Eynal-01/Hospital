...
namespace Hospital.WebUI.Controllers
{
	...
	public class AdminController : Controller
	{
		...
		[HttpPost]
		public async Task<IActionResult> AddAbout(AddAboutViewModel viewModel)
		{
			if (ModelState.IsValid)
			{
				var abouts = await _context.Abouts.ToListAsync();
				var about = new About
				{
					BigTitle = viewModel.BigTitle,
					Content = viewModel.Content,
					FirstContent = viewModel.FirstContent,
				...
				{
					var aboutOld = await _context.Abouts.FirstOrDefaultAsync(d => d.Id == viewModel.Id);
					aboutOld.FirstContent = viewModel.FirstContent;
					aboutOld.Title = viewModel.Title;
					aboutOld.Content = viewModel.Content;
					aboutOld.BigTitle = viewModel.BigTitle;
