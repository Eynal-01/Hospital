...
<<<<<<<< HEAD:Hospital.Entities/Migrations/20240308060120_Init.cs
...
========
                    ...
                    Status = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsPostView = table.Column<bool>(type: "bit", nullable: true),
>>>>>>>> Murad_PatientDevelopmentShow:Hospital.Entities/Migrations/20240308063222_Init.cs
...
>>>>>>>> Murad_PatientDevelopmentShow:Hospital.Entities/Migrations/20240308063222_Init.cs
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_PostViews_Admins_AdminId",
                        column: x => x.AdminId,
                        principalTable: "Admins",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PostViews_Doctors_DoctorId",
                        column: x => x.DoctorId,
                        principalTable: "Doctors",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PostViews_Patients_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patients",
                        principalColumn: "Id");
                    table.ForeignKey(
...
>>>>>>>> Murad_PatientDevelopmentShow:Hospital.Entities/Migrations/20240308063222_Init.cs
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PostViews_AdminId",
                table: "PostViews",
                column: "AdminId");

            migrationBuilder.CreateIndex(
                name: "IX_PostViews_DoctorId",
                table: "PostViews",
                column: "DoctorId");

            migrationBuilder.CreateIndex(
                name: "IX_PostViews_PatientId",
                table: "PostViews",
                column: "PatientId");
